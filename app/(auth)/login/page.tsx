...
import { Flame, Mail, Lock, Loader2, Eye, EyeOff, ArrowLeft } from "lucide-react";
  ...
  return (
    <main className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute top-1/3 left-1/3 w-[400px] h-[400px] rounded-full bg-primary/12 blur-[120px] float" />
        <div className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] rounded-full bg-accent/10 blur-[100px] float-delayed" />
        
        <div className="relative z-10 flex flex-col items-center justify-center w-full p-12 text-center">
          <div className="w-20 h-20 rounded-2xl brand-gradient flex items-center justify-center mb-8 brand-glow">
            <Flame className="w-10 h-10 text-white" />
          </div>
          <h2 className="text-4xl font-bold font-[family-name:var(--font-heading)] mb-4">
            Welcome back,<br />
            <span className="brand-gradient-text">champion.</span>
          </h2>
          <p className="text-muted-foreground max-w-sm leading-relaxed">
            Continue your content journey with premium video content designed for excellence.
          </p>
          
          <div className="mt-12 grid grid-cols-3 gap-6 text-center">
            <div>
              <p className="text-2xl font-bold brand-gradient-text">500+</p>
              <p className="text-xs text-muted-foreground mt-1">Videos</p>
            </div>
            <div>
              <p className="text-2xl font-bold brand-gold-text">4K</p>
              <p className="text-xs text-muted-foreground mt-1">Quality</p>
            </div>
            <div>
              <p className="text-2xl font-bold brand-gradient-text">24/7</p>
        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-bold font-[family-name:var(--font-heading)]">
              Sign <span className="brand-gradient-text">in</span>
            </h1>
